				...
				"subcommands": map[string]interface{}{
					"create": map[string]interface{}{
						...
						"options": []map[string]interface{}{
							...
							{"name": "parse-mode", "type": "string", "required": true, "enum": []string{"standard", "accurate", "fast"}, "description": i18n.T("custom_app_create_parse_mode")},
							{"name": "enable-long-doc", "type": "string", "required": true, "description": i18n.T("custom_app_create_enable_long_doc")},
					...
					"update": map[string]interface{}{
						...
						"options": []map[string]interface{}{
							...
							{"name": "parse-mode", "type": "string", "required": true, "enum": []string{"standard", "accurate", "fast"}, "description": i18n.T("custom_app_update_parse_mode")},
							{"name": "enable-long-doc", "type": "string", "required": true, "description": i18n.T("custom_app_update_enable_long_doc")},
